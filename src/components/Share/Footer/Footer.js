...
const Footer = () => {
    return (
        <div >
            <footer className="footer p-10 bg-slate-500 text-cyan-50 text-base-content">
            ...
            <footer className="footer px-10 py-4 border-t bg-slate-500 text-cyan-50 text-base-content border-base-300">
                <div className="items-center grid-flow-col text-cyan-50">
                ...
                <div className="md:place-self-center md:justify-self-end text-cyan-50">
